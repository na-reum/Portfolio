...
$sql = "SELECT * FROM `free_blog` where no = $no";
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="contact-form-area">
                    <form action="_free_blog_modify.php" method="post" enctype="multipart/form-data">
                      <input type="hidden" name="no" value="<?=$no?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 text-center">
                                ...
                                <button class="btn oneMusic-btn mt-30" type="button" onclick="location.href='free_blog.php'">back</button>&nbsp;
