        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="contact-form-area">
                    <form action="_free_post_write.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <input type="hidden" name="id" value="<?=$_SESSION['id']?>">
                            ...
                            <div class="col-12 text-center">
                                ...
                                <button class="btn oneMusic-btn mt-30" type="button" onclick="location.href='free_post.php'">back</button>&nbsp;
