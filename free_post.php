...
#search_box {
	...
	text-align: center;
          ...
          <p>FreePost Page</p>
            <h2>관리자 모드</h2>
            <button onclick="location.href='free_post_write.php'" class="btn oneMusic-btn mt-30">등록</button>
...
$sqlall = "SELECT * FROM `free_post` where del_flg = '0'";
$count = mysqli_query($conn, $sqlall)->num_rows;
$end_page = ceil($count/10);

$sql = "SELECT * FROM `free_post` where del_flg = '0' order by no desc limit $start, 10";
