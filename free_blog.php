    ...
    <section class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/bg-img/breadcumb3.jpg);">
        <div class="bradcumbContent">
          ...
          <?php if(isset($_SESSION['nickname'])&&$_SESSION['Admin']=='yes'){?>
            ...
            <p>Blog Admin</p>
            <h2>관리자 모드</h2>
            <button onclick="location.href='free_blog_write.php'" class="btn oneMusic-btn mt-30">등록</button>
...
$sqlall = "SELECT * FROM `free_blog` where del_flg = '0'";
$count = mysqli_query($conn, $sqlall)->num_rows;
$end_page = ceil($count/3);

$sql = "SELECT * FROM `free_blog` where del_flg = '0' order by no desc limit $start, 3";
                    ...
                    <div class="single-blog-post mb-100 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="blog-content">
                            ...
                            <div class="post-meta d-flex mb-30">
                                ...
                                <p class="tags">in<a href="free_blog.php"> Blog</a></p>
                            ...
                            <br><br>
                            <form action="free_blog_modify.php" method="post">
                              <input type="hidden" name="no" value="<?=$v['no']?>">
                            <input type="submit" value="수정"/>&nbsp;
                              <button type="button"  onclick="location.href='_free_blog_delete.php?no=<?=$v['no']?>'">삭제</button>&nbsp;
                          </form>
                    ...
                    <div class="oneMusic-pagination-area wow fadeInUp" data-wow-delay="300ms">
                        <nav>
                            <ul class="pagination">
                              ...
                              <?php } else {?>
                                <li class="page-item"><a class="page-link" href="free_blog.php?current_page=1">&laquo;</a></li>
                                <li class="page-item"><a class="page-link" href="free_blog.php?current_page=<?=$prev_page?>"><앞</a></li>
                              <?php } ?>
                              <?php if($current_page==$end_page){ ?>
                                ...
                                <?php } else {?>
                                    <li class="page-item"><a class="page-link" href="free_blog.php?current_page=<?=$next_page?>">뒤</a></li>
                                  <li class="page-item"><a class="page-link" href="free_blog.php?current_page=<?=$end_page?>">&raquo;</a></li>
                                <?php } ?>
