    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                <!-- Slide Img -->
                <div class="slide-img bg-img" style="background-image: url(img/bg-img/a1.jpg);"></div>
                <!-- Slide Content -->
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                              <?php if(isset($_SESSION['nickname'])&&$_SESSION['nickname']=='Admin') {
                                ?>
                                <h6 data-animation="fadeInUp" data-delay="100ms">개발자 이재훈</h6>
                                <h2 data-animation="fadeInUp" data-delay="300ms">관리자 모드 <span>관리자 모드</span></h2>
                                <?php
                              }else{?>
                                <h6 data-animation="fadeInUp" data-delay="100ms">Dev NaRerm</h6>
                                <h2 data-animation="fadeInUp" data-delay="300ms">Portfilo <span>Portfilo</span></h2>
                                <?php
                              }
                            ...
                            <div class="hero-slides-content text-center">
                              <?php if(isset($_SESSION['nickname'])){
                                ...
                                <?php if($_SESSION['nickname']=='Admin'){
                                  ...
                                  <h6 data-animation="fadeInUp" data-delay="100ms">Dev NaLeum</h6>
                                  <h2 data-animation="fadeInUp" data-delay="300ms">Portfilo <span>Portfilo</span></h2>
                                  <?php
                                }
