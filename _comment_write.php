...
// $content = $_POST['content']; $content = str_replace("'", "''", $content);
...
/* <!-- DB 업로드 --> */
$sql = "INSERT INTO `post_comment` (`cno`, `no`, `cid`, `id`, `nickname`, `pw`, `reg_date`, `update_date`, `comment`, `del_flg`) VALUES (NULL, '$no', '$cid', '$id', '$nickname', NULL,  current_timestamp(), NULL, '$comment', '0')";
